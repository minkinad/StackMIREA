...
Создание простого графического интерфейса на Java. Практика собрана из реальных решений в каталоге `pr_Java/Task7`.

## Код из решения

```java title="Windows.java"
...
Task 7 — Базовый GUI теперь отражает фактическую реализацию из `pr_Java/Task7`, а не шаблонный пример.
